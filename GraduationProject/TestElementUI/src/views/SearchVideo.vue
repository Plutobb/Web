<template>
  <div class="cognizance-box">
    <div  class="reDian">搜索到{{this.videos.length}}个视频</div>
    <div v-if="videos.length === 0" style="color: white;margin-left: 80px">搜索结果为空！</div>
...
export default {
  ...
  methods:{
    getSearchVideos(){
      this.request.get("http://localhost:9090/video/search/"+this.searchInput).then(res=>{
