<template>
  ...
  <div id="root">
    ...
    <div class="container--38fle">
      <el-header style="background: white">
        <UserAdminHeader></UserAdminHeader>
      </el-header>
      <div class="content--3ncCf creator-content">
        <div class="sidebar-popover-box--3Zhj7" id="sidebar-popover-box"></div>
        <div class="sider--137Dm creator-sidebar">
          <div class="semi-navigation semi-navigation-vertical">
            <div class="semi-navigation-inner">
              <div class="semi-navigation-header-list-outer">
                <div class="semi-navigation-header">
                  <button @click="uploadVideo()" class="semi-button semi-button-primary semi-button-size-large semi-button-block" type="button"
                          style="margin: 0px;"><span class="semi-button-content">发布视频</span></button>
                </div>
                    ...
                    <el-col :span="24">
                      ...
                      >
                        ...
                        <el-submenu index="2">
                          ...
                          <el-menu-item-group>
                            <el-menu-item index="/follows">关注管理</el-menu-item>
                        ...
                        <el-submenu index="3">
                          ...
                          <el-menu-item-group>
                            <el-menu-item index="/userInfo/update">修改个人信息</el-menu-item>
                          </el-menu-item-group>
                        </el-submenu>
...
export default {
  name: "UserAdmin",
  components: {UserAdminHeader},
  methods:{
    uploadVideo(){
      this.$router.replace('/video/upload')
    }
  }
